...
See `docs/COMMERCE_INTEGRATION_ARCHITECTURE.md` for the canonical integration model covering offer sources, Klarna boundaries, monetization routing, Figma/Canva project separation, and the mandatory one-vertical/one-Shopify-store isolation rule.
